...
![Expression of search for a Hub component with Lightning Bolt menu showing Create Hub option](../images/page135_img01.png)

Click on Create Hub from the Lightning Bolt feature in the Expression of [search for a Hub] component.

![Create Quick Hub dialog with Hub Title field, No Hub Creator/Select Creator options, Create Hub and Cancel buttons](../images/page136_img01.png)
...
![Create Quick Hub dialog filled in with "Barn owls (Twilight animals)" and creator "Andrews, Elizabeth, 1996-"](../images/page136_img02.png)

Click on Create Hub.

![Hub creation confirmation showing the Hub was created with a link to edit it further](../images/page137_img01.png)

![Expression of search for a Hub populated with "Barn owls (Twilight animals)" and Creator of Work with "Andrews, Elizabeth, 1996-" and title "Barn owls"](../images/page137_img02.png)

---

## Search Related Work: Thoughts
