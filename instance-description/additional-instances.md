...
about multiple resources. For example: a book with an accompanying DVD, a DVD with a CD, or a map with a link to a digitized image of the map. Secondary Instances in Marva provide minimal information that focuses on the technical details of that Instance.
