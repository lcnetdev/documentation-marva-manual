...
![Search LCNAF for "Uppsala universitet" with authority record showing CorporateName and variants](../images/page069_img01.png)

![Institution field showing linked "Uppsala universitet" with green verification icon](../images/page069_img02.png)

If the granting institution is not in the LC/NACO Authority File, a literal value can be used:

![Search for "My Local College" showing literal value option](../images/page069_img03.png)

![Institution field showing "My Local College" as a literal value with warning icon](../images/page069_img04.png)

### Date

Record a value from any source. This is a literal value.

![Date field showing "1976"](../images/page069_img05.png)
...
![Note field showing "Thesis (M.A.)--University of London, 1923."](../images/page069_img06.png)
...
![Dissertation component with unstructured note and lightning bolt menu showing Delete Component option](../images/page070_img01.png)
