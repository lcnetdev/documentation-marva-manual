...
![Government publication showing "federal (f)" selected](../images/page055_img02.png)
...
![Government publication showing federal (f) and state (s)](../images/page055_img03.png)

If the component is no longer needed, delete it.

![Lightning bolt menu showing Delete Component option for Government publication](../images/page055_img04.png)
