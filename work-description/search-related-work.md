...
This is a lookup search for identifying Works or Series that are related to the Work being cataloged. Although LC policy does not require controlled access points for series, searching for the series is optional. But in a linked data environment, there is value in the ability to point to an actionable URI for the series heading.
...
![Hubs-Left Anchored search for "Bronte, Charlotte" showing Jane Eyre Hub with authority record details](../images/page063_img01.png)

![Search related work showing "part" relationship with Bronte, Charlotte, 1816-1855. Jane Eyre linked and MARC output](../images/image-1783612353858.png)
...
![Use lightning button to add another component](../images/image-1783612880726.png)

![Works-Keyword search showing Modernism and landscape architecture](../images/page065_img01.png)

![Multiple Search related work components showing "part" with Legacies of modernism and "inspired by" with Modernism and landscape architecture](../images/page065_img02.png)
...
![Lightning bolt menu showing Delete Component option for Search related work/series](../images/image-1783613255177.png)
