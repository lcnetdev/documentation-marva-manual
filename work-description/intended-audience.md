...
![Intended audience showing "juvenile" selected with MARC 008 output showing "j" value](../images/page044_img01.png)
...
![Intended audience showing "Ages 5 and up" as literal value with MARC 521 output](../images/page045_img01.png)
...
![Intended audience showing "Adult" with Source "Follett Library Resources(uncontrolled)" and MARC 521 output](../images/page045_img02.png)
...
![Intended audience showing "Teenagers" with LCDGT source and MARC 385 output](../images/page045_img03.png)

Using LCDGT terms is optional.

To add additional terms for Intended audience, add an additional component.

![Lightning bolt menu showing Add Another Component for Intended audience, with multiple audience values displayed](../images/page045_img04.png)
