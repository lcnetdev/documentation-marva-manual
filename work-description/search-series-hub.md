...
![Relationship field showing "in series" selected](../images/page060_img01.png)

## Search Series Hub

This is a lookup to the LC/NACO Authority File and to BIBFRAME Hubs.

![Search Series Hub showing Hubs - Left Anchored search for "counterpoints" with results list](../images/page061_img01.png)

![Marva search interface showing Counterpoints (New York, N.Y.) selected with Hub details and MARC key](../images/page061_img02.png)

The selected series Hub will be linked in the component:

![Search series Hub showing "in series" relationship with "Counterpoints (New York, N.Y.)" linked](../images/page061_img03.png)
...
![Series enumeration field showing "Volume 3"](../images/page061_img04.png)

If you want to search for an additional series Hub, add an additional component.

![Two Search series Hub components showing Counterpoints (New York, N.Y.) and Urban studies (Peter Lang Publishing)](../images/page062_img01.png)
