...
![Supplementary content showing "bibliography (bibliography)" selected](../images/page054_img01.png)

If you want to record additional values for Supplementary content values in the Work, they can be added in the same field.

![Supplementary content showing bibliography (bibliography), index (index), historical information (historicalinfo)](../images/page054_img02.png)
...
![Two separate Supplementary content components: one with "bibliography" and one with "index (index)" showing correct MARC 008 output](../images/page054_img03.png)
...
![Supplementary content showing historical information being removed](../images/page054_img04.png)

![Supplementary content showing bibliography, index, biography of creator after replacement](../images/page054_img05.png)
