...
![Content type component with Insert Default Values option highlighted and lightning bolt menu](../images/image-1772570022482.png)

![Content type showing "text" as the selected value](../images/page047_img02.png)

Additional values for Content type can be added in the same field.

![Content type showing multiple values: text (txt), computer program (cop), two-dimensional moving image (tdi)](../images/page047_img03.png)
...
![Content type showing replacement of computer program with still image](../images/page047_img04.png)

![Content type showing text (txt), two-dimensional moving image (tdi), still image (sti)](../images/page047_img05.png)

If the component is no longer needed, delete it. But remember that Content type is a Core value.

![Delete component action menu](../images/image-1772570190017.png)
