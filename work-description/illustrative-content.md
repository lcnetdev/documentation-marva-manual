...
![Illustrative content showing "illustrations (ill)" selected](../images/page052_img01.png)
...
![Illustrative content showing multiple values: illustrations (ill), maps (map), facsimiles (fac)](../images/page052_img02.png)
...
![Illustrative content showing facsimiles being removed](../images/page052_img03.png)

![Illustrative content showing illustrations (ill), maps (map), charts (chr) after replacement](../images/page052_img04.png)

If the component is no longer needed, delete it.

![Lightning bolt menu showing Delete Component option for Illustrative content](../images/page052_img05.png)
