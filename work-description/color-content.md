...
![Color content showing "color (mul)" selected](../images/page053_img01.png)

If you want to record additional values for Color content in the Work, they can be added in the same field.

![Color content showing color (mul) and hand colored (hnd)](../images/page053_img02.png)

To change information in this component, click on the **X** next to the Color content value, and search for the new value.

![Color content showing hand colored being removed](../images/page053_img03.png)

![Color content showing color (mul) and mixed color (mix) after replacement](../images/page053_img04.png)

If the component is no longer needed, delete it.

![Lightning bolt menu showing Delete Component option for Color content](../images/page053_img05.png)
