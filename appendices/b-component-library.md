# Appendix B: Using the Component Library
...
![Sidebars - Property preferences with Default Component Library checkbox and Property Panel showing Defaults](../images/page111_img01.png)

![Property Panel showing Notes about the Work and Contents components](../images/page111_img02.png)
...
![Default Component Library showing available component sets including At head, Bib, Bib/Index, Board books, Caption title, and more](../images/page112_img01.png)

![Property Panel showing Add Bib/Index being selected with mouse cursor](../images/page112_img02.png)

Marva will prompt you to add the Default values every time you use the Default Component Library.

![Confirmation dialog: "Add Component From Library?" with OK and Cancel buttons](../images/page112_img03.png)

> **Note:** You can remove this prompt by unchecking the **Prompt to add Library Component** box at Preferences --> Sidebars -- Property.

![Sidebars - Property preferences with Prompt to add Library Component option highlighted](../images/page112_img04.png)

Once the Default Component Library selection is confirmed, the values are added to the description.

![Populated Supplementary content and Notes about the Instance fields showing bibliography and index values](../images/page113_img01.png)
...
![Default Component Library showing full list of options in Property Panel](../images/page113_img02.png)
...
![Sidebars - Property preferences with Component Library checkbox and Property Panel showing Library: Instance with Extent](../images/page114_img01.png)

![Property Panel showing Library: Instance with Extent and Library: Work sections](../images/page114_img02.png)
...
![Input transcribed series component with Lightning Bolt menu showing Add To Library option](../images/page114_img03.png)
...
![Naming dialog showing default name "Input transcribed series" and renamed to "Series: All about insects"](../images/page115_img01.png)

![Property Panel showing Library: Work with "Series: All about insects" added](../images/page115_img02.png)
...
![Subjects component with Lightning Bolt menu showing Add To Library option](../images/page115_img03.png)

Marva will prompt you to name the component for the Library. The default name will be the name of the component. You can change that name to something else if you want.

![Naming dialog showing default name and renamed to "Subject: Insects--Juvenile literature"](../images/page115_img04.png)

![Property Panel showing Library: Work with Series and Subject components](../images/page116_img01.png)
...
![Provision activity component with Lightning Bolt menu showing Add To Library option](../images/page116_img02.png)

Marva will prompt you to name the component for the Library. The default name will be the name of the component. You can change that name to something else if you want.

![Naming dialog showing default name and renamed to "Provision activity: Insects"](../images/page116_img03.png)

![Property Panel showing Library: Instance with Extent and Provision activity, and Library: Work with Series and Subject](../images/page116_img04.png)
...
![Group selection dropdown showing No Group, Group A through Group P](../images/page117_img01.png)
...
![Property Panel showing Library: Multi with all three components grouped under Group A](../images/page117_img02.png)
...
![Add Component From Library confirmation dialog with OK and Cancel buttons](../images/page118_img01.png)

Click OK and the three components will populate the Marva description.

![Populated Subjects, Input transcribed series, and Provision activity fields with library values applied](../images/page118_img02.png)
...
1. **Access the Management Menu:**
   ...
   ![Component management showing gear icon on component in Library: Instance](../images/page117_img03.png)

2. **Management Options:**

   - **Remove:** Delete the component from the library.

     ![Library: Instance with illustrations & maps component and management icons](../images/page117_img03.png)

   - **Rename:** Change the name of the component.

     ![Library: Instance showing renamed component with associated Notes about the Instance](../images/page117_img03.png)
