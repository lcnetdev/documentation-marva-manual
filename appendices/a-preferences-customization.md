...
![Preferences menu showing all customization categories](../images/page101_img01.png)
...
![Field Colors preference panel showing color options for Work and Instance fields](../images/page101_img02.png)

### Set Mandatory Field Color

![Set Mandatory Field Color with color palette popup](../images/page101_img03.png)
...
![Set Color All Fields with Default Color palette expanded](../images/page102_img01.png)
...
![Themes submenu showing Default, Dark, and Gray options](../images/page103_img01.png)
...
![Customization categories menu](../images/page105_img03.png)
...
![Nav Bar preferences showing Height, Font Size, Background Color, and Text Color](../images/page107_img01.png)

## Sidebars -- Previews, Sidebars -- Properties, and Shelflisting

### Sidebars -- Previews

![Sidebars customization menu with Sidebars - Previews highlighted](../images/page107_img02.png)

The right-hand panel in Marva is called the Preview Sidebar. A Preview can be selected from the View icon in the Nav Bar:

![View menu showing Properties, Dual Edit, Preview OPAC, Preview XML, and Preview MARC options](../images/page107_img03.png)

![Sidebars - Previews preferences showing Background Color, Highlight Color, Sidebar width, Font Size, Font, Text Color, No Scrollbar, and MARC HTML options](../images/page107_img04.png)
...
![Sidebars - Property preferences showing Background Color, Highlight Color, Sidebar width, Font Size, Font, Text Color, Empty indicator color, Populated indicator color, No Scrollbar, Type Labels, Number Labels, Accordion List, and Component Library](../images/page108_img01.png)
...
![Shelflisting preferences showing Link Labels, Link URLs, and Display cutter tools option](../images/page108_img02.png)

**Display Cutter Tools** is checked to show the Cutter Calculator in the Classification numbers component.

![Classification numbers component with Cutter Calculator showing](../images/page109_img01.png)
...
2. Go to this address in Chrome (copy and paste into URL field):
   ...
   **chrome://settings/content/siteData**
   ...
   ![Chrome site data settings showing "Allow sites to save data on your device" selected](../images/page110_img01.png)
